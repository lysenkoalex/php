<?php
    ...
    define('FOLDER_NOT_EXIST', 'Folder not found');
    define('FILE_NOT_EXIST', 'File not exist');
    define('FILE_IS_EXIST', 'File with that name already exists');
    ...
    define('FILE_UPLOADED', 'File uploaded successful');
